...
#'
#' @description
#' Synthetically produced data are provided to test the algorithms in the package.
#'
#' @usage data(toy)
#'
#' @format
...
#' }
#'
#' @source \href{https://github.com/drwolf85/HRTnomaly/blob/master/data/toy.rda}{HRTnomaly} R package.
#'
#' @examples
#' # Load the package
#' library(HRTnomaly)
